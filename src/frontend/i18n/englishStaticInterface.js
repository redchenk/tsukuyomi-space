...
const TEXT = Object.freeze({
  ...
  '与你一起，把时间慢下来。': 'A little time together.', '安静陪伴': 'Quiet company',
  '查看对话开头': 'Conversation start', '结束并写日记': 'End & journal',
  '聊天记录': 'Chat history', '回到最新消息': 'Back to latest',
  '这条消息的操作': 'Message actions', '这条回复的操作': 'Reply actions',
  '这一刻，慢慢聊': 'Take your time', '今天的小事、想说的话，都可以留在这里。': 'A little moment, a thought — share it here.',
  '聊天开场建议': 'Conversation starters', '今天过得怎么样？': 'How was your day?', '想和你聊聊天': 'Let’s talk', '给我一点鼓励': 'A little encouragement',
  '房间': 'Room', '日记': 'Journal', '八千代': 'Yachiyo', '搜索': 'Search', '月读空间导航': 'Tsukuyomi navigation', '私人居所': 'Private Room',
  '搜索月读空间': 'Search Tsukuyomi', '搜索月读空间文章': 'Search Tsukuyomi articles',
  '八千代的房间': 'Yachiyo’s room', '和八千代一起，把时间慢下来。': 'Slow down with Yachiyo.',
  '月夜小屋': 'Moonlit room', '窗外的此刻': 'Outside your window', '房间与角色设置': 'Room and character settings',
  '你来啦。刚好，': 'There you are.', '给自己留一点放空的时间。': 'Take a moment just for yourself.',
  '正在听你说': 'Listening to you', '等待与你见面': 'Getting ready to meet you', '此刻，在月读相遇。': 'A moment together in Tsukuyomi.',
  '角色与音乐控制': 'Character and music controls', '打开房间音乐列表': 'Open room music', '播放房间音乐': 'Play room music',
  '选择一首喜欢的歌': 'Choose a song', '表情': 'Expressions', '动作': 'Motions',
  '微笑': 'Smile', '害羞': 'Shy', '惊讶': 'Surprised', '自然': 'Relaxed', '点点头': 'Nod', '轻轻摇摆': 'Sway', '靠近一点': 'Lean closer',
  '保存角色截图': 'Save character screenshot', '语音设置': 'Voice settings', '退出全屏': 'Exit fullscreen', '全屏角色舞台': 'Fullscreen character stage',
  '当前浏览器暂不支持全屏。': 'Fullscreen is unavailable in this browser.', '暂时无法进入全屏，请稍后再试。': 'Could not enter fullscreen. Please try again.',
  '角色仍在准备，请稍后再试。': 'Yachiyo is still getting ready. Please try again shortly.',
  '截图未完成，请保持页面可见后重试。': 'Keep this page visible and try the screenshot again.', '截图未完成，请重试。': 'Could not capture the screenshot. Please try again.',
  '角色截图已保存': 'Character screenshot saved', '浏览器无法保存截图。': 'The browser could not save the screenshot.',
  '房间工作区': 'Room workspace', '房间设置与长期记忆': 'Room settings and long-term memory', '查看本次对话开头': 'View the start of this conversation',
  '我先说': 'Let Yachiyo start', '让八千代先开口': 'Let Yachiyo start the conversation', '和八千代说点什么…': 'Say something to Yachiyo…',
  'Enter 发送 · Shift + Enter 换行': 'Enter to send · Shift + Enter for a new line',
  'AI 角色对话 · 请理性判断生成内容': 'AI companion · Responses may be inaccurate',
  '复制这条回复': 'Copy this reply', '已复制': 'Copied', '请选中文字复制': 'Select the text to copy',
