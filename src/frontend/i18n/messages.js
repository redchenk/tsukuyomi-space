...
export const i18n = {
    ...
    zh: {
        ...
        game: '辉夜快跑',
        gameLoading: '正在加载游戏',
        gameUnavailable: '游戏加载失败',
        gameFullscreen: '全屏',
        gameStandalone: '独立打开',
        gameOriginalAuthor: '原作者',
        gameLeaderboard: '积分榜',
        gameCurrentScore: '本局',
        gameBestScore: '最高',
        gameLeaderboardEmpty: '还没有上榜记录',
        gameLeaderboardUnavailable: '积分榜暂时无法加载',
        gameLoginToRank: '登录后自动记录最高分',
        gameRank: '排名',
        reality: '现实回廊',
        ...
        attachments: '附件库',
        language: '语言',
        switchToJapanese: '切换为日语',
        switchToChinese: '切换为中文',
        lightTheme: '浅色',
        darkTheme: '深色',
        switchLightTheme: '切换浅色主题',
        switchDarkTheme: '切换深色主题',
        ...
        forgotPassword: '忘记密码',
        resetPassword: '重设密码',
        resetPasswordSubtitle: '验证邮箱后设置新密码',
        resetCodeSent: '如果邮箱已注册，验证码将发送到邮箱',
        resetPasswordFailed: '密码重设失败',
        resetPasswordSuccess: '密码已重设，正在登录...',
        resetAndLogin: '重设并登录',
        ...
        realitySupportTitle: '支持项目',
        realitySupportLead: '如果月读空间为你带来了帮助，可以通过爱发电自愿支持服务器、对象存储、CDN 与持续维护。',
        realitySupportAction: '前往爱发电',
        realitySupportNote: '支持完全自愿，不会影响站内功能、内容审核或用户权限。',
        realitySupportImageAlt: '通过爱发电支持 redchenk 和月读空间',
        ...
        realityNoticeUpdate: '本页会随着站点功能变化进行调整。最近更新日期：2026-09-19。',
        realityFooterBack: '返回中枢大厅',
        realityFooterBrand: '月读空间 Reality Anchor',
        editorTitle: '文章编辑器',
        editorSubtitle: '写下公告、传说、技术记录或二创作品',
        ...
        editorExcerptHint: '摘要会显示在文章列表和详情中。可一键生成后修改；留空发布时自动从正文提取。',
        editorSummaryGenerate: '自动摘要',
        editorSummaryGenerating: '生成中…',
        editorSummaryNeedsContent: '请先填写正文，再生成摘要。',
        editorSummaryReady: '已从正文提取摘要，可以继续修改。',
        editorSummaryChanged: '正文或摘要已修改，请重新生成。',
        editorSummaryFailed: '摘要生成失败，请重试或手动填写。',
        ...
        editorRequired: '请完整填写标题、分类、阅读时间和正文',
        ...
        ucPasswordTooShort: '新密码长度至少 8 位',
    ...
    ja: {
        ...
        stageDesc: '記事とコンテンツ',
        arena: 'ピクセルアート',
        arenaDesc: 'ピクセルアートと共有ギャラリー',
        game: 'かぐやラン',
        gameLoading: 'ゲームを読み込み中',
        gameUnavailable: 'ゲームを読み込めませんでした',
        gameFullscreen: 'フルスクリーン',
        gameStandalone: '別ウィンドウで開く',
        gameOriginalAuthor: '原作者',
        gameLeaderboard: 'スコアランキング',
        gameCurrentScore: '今回',
        gameBestScore: 'ベスト',
        gameLeaderboardEmpty: 'まだ記録がありません',
        gameLeaderboardUnavailable: 'ランキングを読み込めません',
        gameLoginToRank: 'ログインするとベストスコアを自動保存します',
        gameRank: '順位',
        reality: 'リアル回廊',
        ...
        resetPasswordSubtitle: 'メール認証後に新しいパスワードを設定します',
        resetCodeSent: '登録済みの場合、認証コードをメールで送信します',
        resetPasswordFailed: 'パスワードを再設定できませんでした',
        resetPasswordSuccess: 'パスワードを再設定しました。ログインしています...',
        resetAndLogin: '再設定してログイン',
        resettingPassword: 'パスワードを再設定しています',
        backToLogin: 'ログインに戻る',
        ...
        statsMessagesNote: '公開中の親メッセージのみ',
        statsUptime: '稼働時間',
        ...
        realitySupportTitle: 'プロジェクトを支援',
        realitySupportLead: '月読空間を気に入っていただけたら、愛発電からサーバー、オブジェクトストレージ、CDN、継続的なメンテナンスを任意で支援できます。',
        realitySupportAction: '愛発電を開く',
        realitySupportNote: '支援は完全に任意であり、サイト機能、コンテンツ審査、ユーザー権限には影響しません。',
        realitySupportImageAlt: '愛発電で redchenk と月読空間を支援',
        ...
        realityNoticeUpdate: 'このページはサイト機能の変更に伴い更新されます。最終更新日：2026-09-19。',
        realityFooterBack: '中枢ホールに戻る',
        realityFooterBrand: '月読空間 Reality Anchor',
        editorTitle: '記事エディター',
        editorSubtitle: 'お知らせ、伝説、技術記録、二次創作を書く',
        ...
        editorCatFanwork: '二次創作',
        editorCatOther: 'その他',
        editorFieldReadTime: '読了時間',
        editorReadTimePh: '例：5 min',
        editorFieldExcerpt: '概要',
        editorExcerptPh: '200字以内で概要を書く',
        editorExcerptHint: '一覧と記事に表示されます。自動生成後も編集できます。空欄の場合、公開時に本文から抽出します。',
        editorSummaryGenerate: '概要を自動生成',
        editorSummaryGenerating: '生成中…',
        editorSummaryNeedsContent: '先に本文を入力してください。',
        editorSummaryReady: '本文から概要を抽出しました。編集できます。',
        editorSummaryChanged: '本文または概要が変更されました。再生成してください。',
        editorSummaryFailed: '生成できませんでした。再試行するか手動で入力してください。',
