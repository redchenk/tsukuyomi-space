...
const FEATURE_TIPS = {
  zh: [
    ...
    { key: 'arena-draw', routeName: 'pixel', title: '像素工坊', body: '这里可以画像素画、上传图片转换像素画，完成后发布到公开作品区。' },
    { key: 'arena-manage', routeName: 'pixel', title: '作品管理', body: '已发布的像素画可以从个人中心再次编辑或删除；管理员可以管理全站作品。' },
  ...
  ja: [
    ...
    { key: 'arena-draw', routeName: 'pixel', title: 'ピクセル工房', body: 'ピクセルアートを描いたり、画像をピクセル化して公開できます。' },
    { key: 'arena-manage', routeName: 'pixel', title: '作品管理', body: '公開済みの作品はユーザーセンターで再編集や削除ができます。管理者は全作品を管理できます。' },
