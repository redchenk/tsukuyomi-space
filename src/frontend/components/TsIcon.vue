...
const iconPaths = {
  ...
  cloud: [
    ['path', { d: 'M17.5 19H9a7 7 0 1 1 6.7-9H17.5a4.5 4.5 0 1 1 0 9Z' }]
  ],
  cloudSun: [
    ['path', { d: 'M12 2v2' }],
    ['path', { d: 'm4.9 4.9 1.4 1.4' }],
    ['path', { d: 'M2 12h2' }],
    ['path', { d: 'M7.6 12.3A4 4 0 1 1 15 9.6' }],
    ['path', { d: 'M17.5 19H9a5 5 0 1 1 4.8-6.4H17.5a3.2 3.2 0 1 1 0 6.4Z' }]
  ],
  cloudRain: [
    ['path', { d: 'M17.5 18H9a7 7 0 1 1 6.7-9H17.5a4.5 4.5 0 1 1 0 9Z' }],
    ['path', { d: 'M9 22v-2' }],
    ['path', { d: 'M13 22v-2' }],
    ['path', { d: 'M17 22v-2' }]
  ],
  ...
  cloudFog: [
    ['path', { d: 'M17.5 17H9a7 7 0 1 1 6.7-9H17.5a4.5 4.5 0 1 1 0 9Z' }],
    ['path', { d: 'M4 20h16' }],
    ['path', { d: 'M7 22h10' }]
  ],
  cloudLightning: [
  ...
  eyeOff: [
    ['path', { d: 'M3 3l18 18' }],
    ['path', { d: 'M10.7 5.2A10.8 10.8 0 0 1 12 5c6.5 0 10 7 10 7a17.6 17.6 0 0 1-3.2 4.2' }],
    ['path', { d: 'M6.6 6.7A17.2 17.2 0 0 0 2 12s3.5 7 10 7c1.6 0 3-.4 4.2-1' }],
